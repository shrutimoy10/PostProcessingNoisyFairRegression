...
for noise_level in gamma :  
  ...
  plt.savefig("univ/noisy_kde_plot_" + str(noise_level) +  ".png")
  plt.close()
...
plt.title("Train MSE")
plt.legend()
plt.savefig("univ/MSE_train_deconv_test_0.6.pdf", dpi=200)
plt.close()
...
plt.title("Test MSE")
plt.legend()
plt.savefig("univ/MSE_test_deconv_test_0.6.pdf", dpi=200)
plt.close()
...
plt.legend()
plt.savefig("univ/KS_dist_train_deconv_test_0.6.pdf", dpi=200)
plt.close()
...
plt.legend()
plt.savefig("univ/KS_dist_test_deconv_univ.pdf", dpi=200)
plt.close()
...
plt.legend()
plt.savefig("univ/w_est_error_test_0.6.pdf", dpi=200)
plt.close()
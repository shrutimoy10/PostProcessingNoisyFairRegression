...
plt.savefig("sa_law/kde_plot.png")
plt.close()
...
for noise_level in gamma :  
  ...
  plt.savefig("sa_law/noisy_kde_plot_" + str(noise_level) +  ".png")
  plt.close()
...
plt.title("Train MSE")
plt.legend()
plt.savefig("sa_law/MSE_train_deconv.pdf", dpi=200)
plt.close()
...
plt.title("Test MSE")
plt.legend()
plt.savefig("sa_law/MSE_test_deconv.pdf", dpi=200)
plt.close()
...
plt.legend()
plt.savefig("sa_law/KS_dist_train_deconv.pdf", dpi=200)
plt.close()
...
plt.legend()
plt.savefig("sa_law/KS_dist_test_deconv.pdf", dpi=200)
plt.close()